  ...
  _createClass(Gauge, [{
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      if (nextProps.value !== this.props.value) {
        ...
        this.tween = func('val', this.state.val, nextProps.value).then(function (timer) {
    ...
    value: function render() {
      ...
      var valueData = [{ number: 0, color: '#aaa' }, { number: val, color: '#eee' }, { number: max - val, color: 'rgba(0,0,0,0)' }];
