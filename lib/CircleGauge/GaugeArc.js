...
var GaugeArc = function (_React$Component) {
  _inherits(GaugeArc, _React$Component);

  function GaugeArc(props) {
    _classCallCheck(this, GaugeArc);

    var _this = _possibleConstructorReturn(this, (GaugeArc.__proto__ || Object.getPrototypeOf(GaugeArc)).call(this, props));
