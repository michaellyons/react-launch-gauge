...
var LinearGauge = function (_React$Component) {
  _inherits(LinearGauge, _React$Component);

  function LinearGauge(props) {
    _classCallCheck(this, LinearGauge);

    var _this = _possibleConstructorReturn(this, (LinearGauge.__proto__ || Object.getPrototypeOf(LinearGauge)).call(this, props));
